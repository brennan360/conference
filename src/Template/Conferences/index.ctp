    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo ($conference->main_page_image) ? $this->Html->image($conference->main_page_image, array('style' => 'max-height:50px;','alt'=>'main_page_image')) : 'Missing image'; ?></td>
                <td><?php echo $conference->icon_image ? $this->Html->image($conference->icon_image, array('style' => 'max-height:50px;','alt'=>'icon_image')) : 'Missing image'; ?></td>
                <td class="actions">
