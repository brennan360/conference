...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'username' => ['type' => 'unique', 'columns' => ['username', 'is_active'], 'length' => []],
            'fk_user_company_id' => ['type' => 'foreign', 'columns' => ['company_id'], 'references' => ['companies', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_user_permission_id' => ['type' => 'foreign', 'columns' => ['permission_id'], 'references' => ['permissions', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'company_id' => 1,
                'permission_id' => 1,
                'created' => '2018-06-13 14:36:23',
                'modified' => '2018-06-13 14:36:23'
            ],
        ];
        parent::init();
    }
